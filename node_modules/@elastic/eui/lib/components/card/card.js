...
var EuiCard = function EuiCard(_ref) {
  var className = _ref.className,
      ...
      rest = _objectWithoutProperties(_ref, ['className', 'description', 'title', 'icon', 'image', 'footer', 'onClick', 'href', 'textAlign', 'isClickable', 'betaBadgeLabel', 'betaBadgeTooltipContent', 'betaBadgeTitle']);
  ...
  if (betaBadgeLabel) {
    optionalBetaBadge = _react2.default.createElement(
      ...
      _react2.default.createElement(_beta_badge.EuiBetaBadge, { label: betaBadgeLabel, title: betaBadgeTitle, tooltipContent: betaBadgeTooltipContent, className: 'euiCard__betaBadge' })
    );
  }
