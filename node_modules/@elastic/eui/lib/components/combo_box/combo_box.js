...
var EuiComboBox = exports.EuiComboBox = function (_Component) {
  ...
  function EuiComboBox(props) {
    ...
    var matchingOptions = _this.getMatchingOptions(options, selectedOptions, initialSearchValue);
  ...
  _createClass(EuiComboBox, [{
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      ...
      var matchingOptions = this.getMatchingOptions(options, selectedOptions, nextState.searchValue);
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['id', 'isDisabled', 'className', 'isLoading', 'options', 'selectedOptions', 'onCreateOption', 'placeholder', 'noSuggestions', 'renderOption', 'singleSelection', 'onChange', 'onSearchChange', 'async', 'isInvalid', 'rowHeight', 'isClearable']);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.incrementActiveOptionIndex = (0, _lodash.throttle)(function (amount) {
    ...
    if (!_this3.hasActiveOption()) {
      ...
      nextActiveOptionIndex = amount < 0 ? _this3.matchingOptions.length - 1 : 0;
    } else {
      nextActiveOptionIndex = _this3.state.activeOptionIndex + amount;

      if (nextActiveOptionIndex < 0) {
        nextActiveOptionIndex = _this3.matchingOptions.length - 1;
      } else if (nextActiveOptionIndex === _this3.matchingOptions.length) {
    ...
    while (_this3.matchingOptions[nextActiveOptionIndex].isGroupLabelOption) {
