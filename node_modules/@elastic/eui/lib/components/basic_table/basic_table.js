...
exports.EuiBasicTable = exports.SelectionType = exports.ItemIdType = exports.ColumnType = exports.ComputedColumnType = exports.FieldDataColumnType = undefined;
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var selection = prevState.selection.filter(function (selectedItem) {
        return nextProps.items.findIndex(function (item) {
          return getItemId(item, nextProps) === getItemId(selectedItem, nextProps);
        }) !== -1;
      });
  ...
  _createClass(EuiBasicTable, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'loading', 'items', 'itemId', 'columns', 'pagination', 'sorting', 'selection', 'onChange', 'error', 'noItemsMessage', 'compressed', 'itemIdToExpandedRowMap', 'responsive', 'isSelectable', 'isExpandable', 'hasActions']);
    ...
    value: function renderTableHead() {
      ...
      columns.forEach(function (column, index) {
        ...
        var align = _this4.resolveColumnAlign(column);
        ...
        // field data column
        var sorting = {};
        if (_this4.props.sorting && column.sortable) {
      ...
      var onChange = function onChange(event) {
        if (event.target.checked) {
          ...
          _this7.changeSelection(_this7.state.selection.reduce(function (selection, selectedItem) {
            if (getItemId(selectedItem, _this7.props) !== itemId) {
    ...
    value: function renderItemActionsCell(itemId, item, column, columnIndex) {
      ...
      return _react2.default.createElement(
        _table_row_cell.EuiTableRowCell,
        { showOnHover: true, key: key, align: 'right', textOnly: false, hasActions: true },
        tools
      );
    }
  }, {
