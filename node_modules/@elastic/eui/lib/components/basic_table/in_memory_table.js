  ...
  _createClass(EuiInMemoryTable, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _unuseditems = _props.items,
          search = _props.search,
          rest = _objectWithoutProperties(_props, ['columns', 'loading', 'message', 'error', 'selection', 'isSelectable', 'hasActions', 'compressed', 'pagination', 'sorting', 'itemIdToExpandedRowMap', 'itemId', 'items', 'search']);
      ...
      var table = _react2.default.createElement(_basic_table.EuiBasicTable, _extends({
        items: items,
        itemId: itemId,
        columns: columns,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onQueryChange = function (query) {
    if (_this2.props.search.onChange) {
      var shouldQueryInMemory = _this2.props.search.onChange(query);
