...
var EuiSelect = function EuiSelect(_ref) {
  var className = _ref.className,
      ...
      value = _ref.value,
      rest = _objectWithoutProperties(_ref, ['className', 'options', 'id', 'name', 'inputRef', 'isInvalid', 'fullWidth', 'isLoading', 'hasNoInitialSelection', 'defaultValue', 'compressed', 'value']);
